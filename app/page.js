  ...
  return (
    <div className="mt-20">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {statsData.map((statsData, index) => (
              <div key={index} className="text-center">
                <div className="text-3xl font-bold text-blue-600 mb-2">{statsData.value}</div>
      ...
      <section className="py-15">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl font-bold text-center mb-12">Everything you need to manage your finances</h2>
      ...
      <section className="py-10 bg-blue-700">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-blue-100 mb-8 max-w-2xl mx-auto">Join thousands of users who already managing their finances smarter with Saver</p> 
          <Link href="\dashboard">
